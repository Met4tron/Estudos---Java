...
public class Notebook {
	...
	public String toString() {
		...
		return "Notebook [numeroNote=" + numeroNote + ", modelo=" + modelo + ", descricao=" + descricao + ", estoque="
				+ estoque + ", precoUnitario=" + NumberFormat.getCurrencyInstance(local).format(this.precoUnitario)+", figura=" + figura + ", dataCadastro=" + dataCadastro
				+ "]";
	}
	...
	/*public void mostrarNotebook(){
		...
		System.out.println("------------------------------------");
		System.out.println("Número: " + this.numeroNote);
